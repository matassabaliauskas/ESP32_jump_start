    ...
    while(true){
        ...
        if (millis()-prev_millis >= ADV_SEC * 1000) {
            ...
            unsigned char send_data[6] = {
                ...
                display.setTextColor(WHITE);
                display.setCursor(0,10);
                display.println("3LOGYTECH");
                display.print("Temp: ");
                display.print(myIMU.readTempC());display.println("deg C");
                display.print("SOS: ");
                display.println(SOS_flag);
                display.print("FALL: ");
                display.println(fall_flag);
                display.print("Battery: ");
                display.print(battery_send/1.2);display.println("%");
                display.display(); 
